 ...
 */
	Configure::write('debug',0);//preg_match('/\.dev$/',basename(dirname(dirname(__FILE__)))) ? 2 : 0);
 ...
 *
 */
Configure::write('Cache.check', false);//preg_match('/\.dev$/',basename(dirname(dirname(__FILE__)))) ? false : true);
 ...
 */
	Configure::write('Security.salt', '7b3508d5acb7695672e667ccd89c67dcd3d7173c');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '343336353263373230653836623435');
