...
//Admin
	...
	//		})
		...
		CKEDITOR.config.toolbar = [
				['Source','FontSize','-','Save','NewPage','Preview'],
				...
				['Link','Unlink'],
				['Image','Flash', 'Table','Rule','SpecialChar', 'HorizontalRule'],
				['TextColor','BGColor'],
				['Styles']
			];
		...
		[
		  ...
		  { name : 'Frase texto sem paragrafo', element : 'span', attributes : { 'class' : 'titulo_paginas_4' } },
		  { name : 'Frase texto negrito sem paragrafo', element : 'span', attributes : { 'class' : 'titulo_paginas_5' } },
		]);
