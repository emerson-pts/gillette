								...
								<tr>
									...
									?>	
										<div id="chaves-rodada-<?php echo $i;?>" class="chave-jogo <?php if($i == 0){echo 'final';}?>">
											<div class="chave-jogador-1 <?php if(!empty($jogo['Equipe1Jogador1']['cabeca_chave']) && is_numeric($jogo['Equipe1Jogador1']['cabeca_chave'])){ echo 'chave-jogador-cabeca';}?>">
												<?php 
												if(!empty($jogo['Jogo']['equipe1_jogador1_id'])){
													echo $this->Html->image('flags/'.strtolower($jogo['Equipe1Jogador1']['pais_iso_2']).'.png').'&nbsp;&nbsp;';
													if ($i == ($count_rodadas_processadas-1) && !empty($jogo['Equipe1Jogador1']['cabeca_chave'])){
														echo '('.$jogo['Equipe1Jogador1']['cabeca_chave'].') ';
													}
													
													if ($i == ($count_rodadas_processadas-1)){
														echo $jogo['Equipe1Jogador1']['nome'];
													}else{
														echo preg_replace('/^.* /', '', $jogo['Equipe1Jogador1']['nome']);
													}
												}
											?></div>
											<?php if($chave_atual['Jogo']['qtd_jogadores_equipe'] == 2):?>
												<div class="chave-jogador-1 <?php if(!empty($jogo['Equipe1Jogador2']['cabeca_chave']) && is_numeric($jogo['Equipe1Jogador2']['cabeca_chave'])){ echo 'chave-jogador-cabeca';}?>">
												<?php 
												if(!empty($jogo['Jogo']['equipe1_jogador2_id'])){
													echo $this->Html->image('flags/'.strtolower($jogo['Equipe1Jogador2']['pais_iso_2']).'.png').'&nbsp;&nbsp;';
													if ($i == ($count_rodadas_processadas-1) && !empty($jogo['Equipe1Jogador2']['cabeca_chave'])){
														echo '('.$jogo['Equipe1Jogador2']['cabeca_chave'].') ';
													}
													if ($i == ($count_rodadas_processadas-1)){
														echo $jogo['Equipe1Jogador2']['nome'];
													}else{
														echo preg_replace('/^.* /', '', $jogo['Equipe1Jogador2']['nome']);
													}
												}
												?>
												</div>
											<?php endif;?>
												<div class="chave-jogador-divider"><?php echo $jogo['Jogo']['placar'];?></div>
											<?php
											if($i != 0):
											?>
												<div class="chave-jogador-2 <?php if(!empty($jogo['Equipe2Jogador1']['cabeca_chave']) && is_numeric($jogo['Equipe2Jogador1']['cabeca_chave'])){ echo 'chave-jogador-cabeca';}?>">
													<?php 
													if(!empty($jogo['Jogo']['equipe2_jogador1_id'])){
														echo $this->Html->image('flags/'.strtolower($jogo['Equipe2Jogador1']['pais_iso_2']).'.png').'&nbsp;&nbsp;';
														if ($i == ($count_rodadas_processadas-1) && !empty($jogo['Equipe2Jogador1']['cabeca_chave'])){
															echo '('.$jogo['Equipe2Jogador1']['cabeca_chave'].') ';
														}
														if ($i == ($count_rodadas_processadas-1)){
												...
												?></div>
												<?php if($chave_atual['Jogo']['qtd_jogadores_equipe'] == 2):?>
													<div class="chave-jogador-2 <?php if(!empty($jogo['Equipe2Jogador2']['cabeca_chave']) && is_numeric($jogo['Equipe2Jogador2']['cabeca_chave'])){ echo 'chave-jogador-cabeca';}?>">
													<?php 
													if(!empty($jogo['Jogo']['equipe2_jogador2_id'])){
														echo $this->Html->image('flags/'.strtolower($jogo['Equipe2Jogador2']['pais_iso_2']).'.png').'&nbsp;&nbsp;';
														if ($i == ($count_rodadas_processadas-1) && !empty($jogo['Equipe2Jogador2']['cabeca_chave'])){
															echo '('.$jogo['Equipe2Jogador2']['cabeca_chave'].') ';
														}
														if ($i == ($count_rodadas_processadas-1)){
